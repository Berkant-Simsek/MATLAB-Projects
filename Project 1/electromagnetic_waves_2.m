...
for t = 1:time_steps 
  for i = 2:N-1 
    for j = 2:N-1 
      r = (ep(i,j) == ep0) * r0 + (ep(i,j) == ep_r*ep0) * r1; 
...
total_time_elapsed = T * dt0; 
estimated_wave_velocity = 189545725.974512; 
theoretical_wave_velocity = 189650253.830121; 
